...
- **Type**: Target type specified in cast
- **Description**: Returns the result of the CAST operation.
...
- Return type is Target type specified in cast
...
This example demonstrates basic usage of the CAST function.
...
Query:
```sql
SELECT product_id, product_name, CAST(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how CAST handles NULL values.
...
This example shows a practical application of the CAST function.
...
- **Description**: Returns the result of the NVL operation.
...
This example demonstrates basic usage of the NVL function.
...
Query:
```sql
SELECT product_id, product_name, NVL(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how NVL handles NULL values.
...
This example shows a practical application of the NVL function.
...
- **Description**: Returns the result of the TANH operation.
...
This example demonstrates basic usage of the TANH function.
...
Query:
```sql
SELECT product_id, product_name, TANH(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how TANH handles NULL values.
...
This example shows a practical application of the TANH function.
...
- **Description**: Returns the result of the TAN operation.
...
This example demonstrates basic usage of the TAN function.
...
Query:
```sql
SELECT product_id, product_name, TAN(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how TAN handles NULL values.
...
This example shows a practical application of the TAN function.
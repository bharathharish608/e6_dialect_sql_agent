...
- **Description**: Returns the result of the ATAN operation.
...
This example demonstrates basic usage of the ATAN function.
...
Query:
```sql
SELECT product_id, product_name, ATAN(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how ATAN handles NULL values.
...
This example shows a practical application of the ATAN function.
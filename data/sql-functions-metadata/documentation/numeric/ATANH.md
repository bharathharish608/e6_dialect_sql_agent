...
- **Description**: Returns the result of the ATANH operation.
...
This example demonstrates basic usage of the ATANH function.
...
Query:
```sql
SELECT product_id, product_name, ATANH(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how ATANH handles NULL values.
...
This example shows a practical application of the ATANH function.
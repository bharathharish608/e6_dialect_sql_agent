...
- **Description**: Returns the result of the SHA1 operation.
...
This example demonstrates basic usage of the SHA1 function.
...
Query:
```sql
SELECT product_id, product_name, SHA1(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how SHA1 handles NULL values.
...
This example shows a practical application of the SHA1 function.
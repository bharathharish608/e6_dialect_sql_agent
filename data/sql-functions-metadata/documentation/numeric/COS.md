...
- **Description**: Returns the result of the COS operation.
...
This example demonstrates basic usage of the COS function.
...
Query:
```sql
SELECT product_id, product_name, COS(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how COS handles NULL values.
...
This example shows a practical application of the COS function.
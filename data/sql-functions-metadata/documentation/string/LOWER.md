...
- **Description**: Returns the result of the LOWER operation.
...
This example demonstrates basic usage of the LOWER function.
...
Query:
```sql
SELECT product_id, product_name, LOWER(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how LOWER handles NULL values.
...
This example shows a practical application of the LOWER function.
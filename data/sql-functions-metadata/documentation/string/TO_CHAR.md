...
- **Description**: Returns the result of the TO_CHAR operation.
...
This example demonstrates basic usage of the TO_CHAR function.
...
Query:
```sql
SELECT product_id, product_name, TO_CHAR(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how TO_CHAR handles NULL values.
...
Query:
```sql
-- Practical example using TO_CHAR
...
This example shows a practical application of the TO_CHAR function.
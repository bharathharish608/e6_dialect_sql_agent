...
- **Description**: Returns the result of the UPPER operation.
...
This example demonstrates basic usage of the UPPER function.
...
Query:
```sql
SELECT product_id, product_name, UPPER(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how UPPER handles NULL values.
...
This example shows a practical application of the UPPER function.
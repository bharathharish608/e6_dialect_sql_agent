...
- **Description**: Returns the result of the SPLIT operation.
...
- Return type is ARRAY of strings, nullable
...
This example demonstrates basic usage of the SPLIT function.
...
Query:
```sql
SELECT product_id, product_name, SPLIT(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how SPLIT handles NULL values.
...
This example shows a practical application of the SPLIT function.
...
- **Description**: Returns the result of the RIGHT operation.
...
This example demonstrates basic usage of the RIGHT function.
...
Query:
```sql
SELECT product_id, product_name, RIGHT(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how RIGHT handles NULL values.
...
This example shows a practical application of the RIGHT function.
...
- **Description**: Returns the result of the UCASE operation.
...
This example demonstrates basic usage of the UCASE function.
...
Query:
```sql
SELECT product_id, product_name, UCASE(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how UCASE handles NULL values.
...
This example shows a practical application of the UCASE function.
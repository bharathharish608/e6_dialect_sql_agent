...
- **Type**: NUMERIC
- **Required**: Yes
- **Description**: Numeric value to invert

## Returns

- **Type**: BIGINT NULLABLE
- **Description**: Returns the result of the BITWISE_NOT operation.
...
Query:
```sql
SELECT BITWISE_NOT(12) -- Returns -13 (~1100)
```
...
This example demonstrates basic usage of the BITWISE_NOT function.
...
Query:
```sql
SELECT product_id, product_name, BITWISE_NOT(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how BITWISE_NOT handles NULL values.
...
Query:
```sql
-- Practical example using BITWISE_NOT
...
This example shows a practical application of the BITWISE_NOT function.
...
Query:
```sql
SELECT TO_BASE64('hello') -- Returns 'aGVsbG8='
```
...
This example demonstrates basic usage of the TO_BASE64 function.
...
Query:
```sql
SELECT product_id, product_name, TO_BASE64(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how TO_BASE64 handles NULL values.
...
Query:
```sql
-- Practical example using TO_BASE64
...
This example shows a practical application of the TO_BASE64 function.
...
- **Type**: STRING
- **Required**: Yes
- **Description**: String to calculate CRC32 for

## Returns

- **Type**: BIGINT NULLABLE
- **Description**: Returns the result of the CRC32 operation.
...
This example demonstrates basic usage of the CRC32 function.
...
Query:
```sql
SELECT product_id, product_name, CRC32(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how CRC32 handles NULL values.
...
This example shows a practical application of the CRC32 function.
...
- **Type**: TIMESTAMP
- **Description**: Returns the result of the NOW operation.
...
This example demonstrates basic usage of the NOW function.
...
Query:
```sql
SELECT product_id, product_name, NOW(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how NOW handles NULL values.
...
This example shows a practical application of the NOW function.
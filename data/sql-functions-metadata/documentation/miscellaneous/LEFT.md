...
- **Description**: Returns the result of the LEFT operation.
...
This example demonstrates basic usage of the LEFT function.
...
Query:
```sql
SELECT product_id, product_name, LEFT(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how LEFT handles NULL values.
...
This example shows a practical application of the LEFT function.
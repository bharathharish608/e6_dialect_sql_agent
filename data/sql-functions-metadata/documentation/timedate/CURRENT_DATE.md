...
- **Type**: DATE
- **Description**: Returns the result of the CURRENT_DATE operation.
...
This example demonstrates basic usage of the CURRENT_DATE function.
...
Query:
```sql
SELECT product_id, product_name, CURRENT_DATE(price) AS result
FROM products
ORDER BY product_id;
```
...
This example shows how CURRENT_DATE handles NULL values.
...
Query:
```sql
-- Practical example using CURRENT_DATE
...
This example shows a practical application of the CURRENT_DATE function.